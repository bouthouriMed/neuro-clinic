  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden min-h-[60vh] flex items-center">
        ...
        <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-teal-500/20 rounded-full blur-[150px] animate-pulse-glow" />
        <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-indigo-500/15 rounded-full blur-[120px] animate-morph" />

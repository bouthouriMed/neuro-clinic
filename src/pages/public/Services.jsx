...
import { Brain, ArrowRight, Clock, Activity, Zap, BookOpen, Waves, Move, Sparkles, Shield, Wind, Smile, Heart, ChevronDown } from 'lucide-react'
    ...
    <ScrollReveal delay={index * 100}>
      ...
      >
        <div className="flex items-start justify-between mb-4">
          <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${gradients[index % gradients.length]} flex items-center justify-center shadow-lg group-hover:scale-110 group-hover:rotate-3 transition-all duration-300`}>
        ...
        <div className="flex items-center justify-between mt-4">
          <span className={`text-xs font-medium text-indigo-500 flex items-center gap-1 transition-transform duration-300 ${isExpanded ? 'rotate-180' : ''}`}>
            {isExpanded ? 'Moins' : 'Plus'}
            <ChevronDown className="w-3.5 h-3.5" />
          </span>
          
          {!isExpanded && (
            <Link to="/book" className="no-underline" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="max-w-3xl mx-auto text-center">
            <ScrollReveal>
              ...
              <p className="text-base md:text-lg text-indigo-200/80 leading-relaxed max-w-2xl mx-auto">
                ...
                pour toutes les conditions neurologiques.
              </p>
            </ScrollReveal>
        ...
        <div className="max-w-3xl mx-auto px-6 text-center">
          <ScrollReveal>
            ...
            <p className="text-slate-500 text-lg">
              Découvrez notre gamme complète de services neurologiques conçus pour votre bien-être.
            ...
            <div className="bg-gradient-to-br from-slate-900 via-slate-800 to-indigo-900 rounded-3xl p-8 md:p-12 lg:p-16 text-center relative overflow-hidden">
              ...
              <div className="relative">
                ...
                <p className="text-slate-300 max-w-md mx-auto mb-8 text-sm md:text-base">
                  Réservez votre rendez-vous aujourd'hui et recevez des soins neurologiques experts.
                </p>
